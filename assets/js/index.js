...
//Adds a click event listener to instantly solve the puzzle
...
//Adds a click event listener to toggle between pause and play
...
//Adds a click event listener to reset the puzzle
...
//Adds an event listener to adjust the speed of the solver
document.getElementById("inputSpeed").addEventListener("change",e=>{
  speed = 1001 - e.target.value;
})
//Defines a sample Sudoku puzzle
const testArray = [
  [5,3,0,0,7,0,0,0,0],
  [6,0,0,1,9,5,0,0,0],
  [0,9,8,0,0,0,0,6,0],
